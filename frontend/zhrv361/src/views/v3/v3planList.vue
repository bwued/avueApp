...
export default {
  ...
  methods: {
    ...
    userRepayPlanListFun() {
      ...
      var data = {}
      if (this.active === 0) {
        data = { page: this.currPage, size: 7, cardId: this.$util.getQueryVariable('cardId') }
      } else if (this.active === 1) {
        data = { page: this.currPage, size: 10, state: 'WAITING', cardId: this.$util.getQueryVariable('cardId') }
      } else if (this.active === 2) {
        data = { page: this.currPage, size: 10, state: 'EXECUTING', cardId: this.$util.getQueryVariable('cardId') }
      } else if (this.active === 3) {
        data = { page: this.currPage, size: 10, state: 'SUCCESS', cardId: this.$util.getQueryVariable('cardId') }
      } else if (this.active === 4) {
        data = { page: this.currPage, size: 10, state: 'FAILED',cardId: this.$util.getQueryVariable('cardId') }
      }
