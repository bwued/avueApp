                  ...
                  <div class="w100 flex-column">
                    ...
                    <div class="w100 flex-row-between">
                      <div class="color666">
                        ...
                        <p
                          v-if="item.type == 'MANAGER'"
                          class="size28 lineheight70"
                        >
                          {{ item.source.user_id_card_name +" "+ item.source.username + " 管理奖" }}
                        </p>
                         <p
                          v-else-if="item.type == 'ACTIVITY_REGISTE'"
                          class="size28 lineheight70"
                        >
                          {{ item.source.user_id_card_name +" "+ item.source.username + " 注册奖" }}
                        </p>
                        <p
                          v-else-if="item.type == 'ACTIVITY_TRADE'"
                          class="size28 lineheight70"
                        >
                          {{ item.source.user_id_card_name +" "+ item.source.username + " 激活奖" }}
                        </p>
                      </div>
    ...
    statusChange(value) {
      switch (value) {
        ...
        case '智能管家':
          ...
          break
		case '信用卡申办':
		  this.currentStatus = 'CREDITCARD_APPLY_PROFIT_GROUP'
		  break  
        // 2 提现
        // case '已申请':
        ...
        case '管理奖':
          ...
          break
        case '注册奖':
          this.currentStatus = 'ACTIVITY_REGISTE'
          break
        case '激活奖':
          this.currentStatus = 'ACTIVITY_TRADE'
          break
        // case '注册补贴':
    ...
    statusColumnsList() {
      switch (this.currentNav) {
        case -1:
          ...
          break
        case 0:
          this.statusColumns = ['在线收款', '智能管家','信用卡申办']
        ...
        //   break
        case 1:
          this.statusColumns = ['管理奖', '注册奖', '激活奖']
          this.statusSelect = this.statusSelect || '管理奖'
          this.currentStatus = 'MANAGER'
          break
        // case 2:
