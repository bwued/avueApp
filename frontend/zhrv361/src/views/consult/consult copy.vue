<template>
  <div class="mgb110 recommend-page">
    ...
    <!--<div v-for="(itemg,index) in test" :key="index" class="school clear" v-show="type === 0"  @click="$openShareLinks(itemg.url,itemg.name, 1)">-->
    <div v-for="(itemg,index) in test" v-show="type === 0" :key="index" class="school clear" @click="openWebView(itemg.url,itemg.name)">
      ...
      <div class="school-main">
        ...
        <!-- <div class="school-time">{{itemg.time}}</div> -->
    ...
    <div v-show="type !== 0" class="box">
      <!--<div v-for="(item1,index) in list" :key="index" class="z_shipi" @click="$openShareLinks(item1.url,item1.name, 2)">-->
